...
# folder definitions
theme_folder = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
temp_folder = os.path.join(gettempdir(), 'temp')
...
colors_json = os.path.join(theme_folder, "colors.json")
